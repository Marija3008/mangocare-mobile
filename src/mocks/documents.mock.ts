...
export const medicalDocumentsMock: MedicalDocument[] = [
  {
    ...
    fileUrl: "https://example.com/mock-documents/document-1.pdf",
    type: "lab_report",
    status: "reviewed",
  ...
  },
  {
    ...
    contentType: "application/pdf",
    fileUrl: "https://example.com/mock-documents/document-2.pdf",
    type: "clinical_note",
    status: "reviewed",
  ...
  },
  {
    ...
    contentType: "application/pdf",
    fileUrl: "https://example.com/mock-documents/document-3.pdf",
    type: "prescription",
    status: "reviewed",
  ...
  },
  {
    ...
    contentType: "application/pdf",
    fileUrl: "https://example.com/mock-documents/document-4.pdf",
    type: "insurance",
